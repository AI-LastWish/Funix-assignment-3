...
const variantStyles = {
  solid: {
    ...
    pricing:
      "bg-white text-slate-900 hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white",
    transparent:
      "inline-flex items-center rounded-none hover:border border-gray-300 bg-black px-6 py-3 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2",
  },
  outline: {
    slate:
